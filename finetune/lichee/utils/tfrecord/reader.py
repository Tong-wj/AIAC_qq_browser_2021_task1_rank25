...
def read_org_single_record_with_spec_index(data_path: str,
                                       start_offset: int,
                                       end_offset: int,
                                       description: typing.Union[typing.List[str], typing.Dict[str, str], None] = None,
                                       ) -> typing.Dict:
    ...
    return read_org_single_description(description, record, typename_mapping)
...
def read_org_single_description(description, record, typename_mapping):
    example = example_pb2.Example()
    example.ParseFromString(record)
