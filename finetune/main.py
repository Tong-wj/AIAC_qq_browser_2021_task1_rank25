...
def parse_args():
    ...
    # pretrained models
    # parser.add_argument('--checkpoint', type=str, default='Epoch_2_0.7916_0.4654_0.6846.bin')
    # parser.add_argument('--checkpoint', type=str, default='Epoch_3_0.7890_0.4700_0.6768.bin')
    # parser.add_argument('--checkpoint', type=str, default='Epoch_4_0.8070_0.4624_0.6790.bin')

    # parser.add_argument('--checkpoint', type=str, default='Epoch_5_0.8118_0.4840_0.6784.bin')

    # parser.add_argument('--checkpoint', type=str, default='Epoch_5_0.6168.bin')
    ...
    # finetuned models
    parser.add_argument('--checkpoint', type=str, default='Epoch_25_0.9483.bin')
    # parser.add_argument('--checkpoint', type=str, default='Epoch_11_0.8207.bin')
    # parser.add_argument('--checkpoint', type=str, default='Epoch_6_0.9383.bin')
    # parser.add_argument('--checkpoint', type=str, default='Epoch_3_0.9351.bin')

    # parser.add_argument('--checkpoint', type=str, default='Epoch_10_0.8241_0.5822_0.6672.bin')
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        trainer.train(dataset_key=args.dataset, checkpoint_file=args.checkpoint)
